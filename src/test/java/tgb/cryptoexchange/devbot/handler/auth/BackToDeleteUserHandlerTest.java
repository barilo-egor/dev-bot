...
class BackToDeleteUserHandlerTest {
    @Mock
    private AuthMenuService authMenuService;

    @InjectMocks
    private BackToDeleteUserHandler backToDeleteUserHandler;
